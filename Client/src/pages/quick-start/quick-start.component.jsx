...
import { hideNavbar, showNavbar, startTime, resetTime } from '../../redux/ui/ui.actions';
...
class QuickStart extends React.Component {
	...
	render() {
		const { workoutData, addExercise, showNavbar, time, resetTime, resetWorkout, stopTime } = this.props;
		return (
			<React.Fragment>
				<div className="quick-start">
					...
					<button className="btn btn--add" onClick={() => this.setState({ addingExercise: true })}>
						Uebung hinzufuegen
					</button>
				</div>
				<Modal show={this.state.addingExercise} modalClosed={this.addNameHandler}>
					<input
						type="text"
...
export default connect(mapStateToProps, mapDispatchToProps)(withRouter(QuickStart));
